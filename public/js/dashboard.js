...
$(document).ready(function() {
    ...
    $("#earningAndExpenseYear").change(function(){
        ...
        if(year){
            $("#yearAccountLoading").html("<i class='"+spinnerClass+"'></i> Chargement...");
...
function getEarnings(year){
    ...
    $.ajax({
        ...
        var barChartData = {
          labels : ["Jan", "Fev", "Mar", "Avr", "Mai", "Jun", "Jul", "Août", "Sept", "Oct", "Nov", "Dec"],
          datasets : [{
        ...
        document.getElementById('earningsTitle').innerHTML = "Gains (" + response.earningsYear +")";
