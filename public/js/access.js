...
loginForm.onsubmit = function(e){
    ...
    if(!email || !password){
        var errMsg = !email ? "Entrer votre Email" : "Entrer votre Mot de passe";
        
        document.getElementById('errMsg').innerHTML = errMsg;
    }
    
    else{
        document.getElementById('errMsg').innerHTML = "Authentification ......";
	...
	handleLogin(email, password, function(returnedData){
	   if(returnedData.status === 1){
                document.getElementById('errMsg').innerHTML = "Authentifié. Redirection ....";
