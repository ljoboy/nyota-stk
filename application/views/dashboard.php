    ...
    <?php if ($this->session->admin_role === "Super"): ?>
        <div class="col-sm-4">
            <div class="panel panel-info">
                ...
                <div class="panel-footer text-center" style="color:#f0ad4e">Total des transactions de tous les temps
                </div>
            </div>
        </div>
    <?php endif; ?>
...
<?php if ($this->session->admin_role === "Super"): ?>
    ...
    <div class="row margin-top-5">
        <div class="col-sm-9">
            <div class="box">
                ...
                <div class="box-body" style="background-color:/*#33c9dd*/#5fa4b4;">
                    <canvas style="padding-right:25px" id="earningsGraph" width="200" height="80"/>
                    </canvas>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-3">
            ...
            <section class="panel">
                <center>
                    <canvas id="paymentMethodChart" width="200" height="200"/>
                    </canvas><br>Méthodes de payement(%)<span id="paymentMethodYear"></span>
                </center>
            </section>
        </div>
    </div>
