...
class Admin extends CI_Model
{
    ...
    */
    ...
    public function update_last_login($admin_id)
    {
        ...
        //set the datetime based on the db driver in use
        $this->db->platform() == "sqlite3" ? $this->db->set('last_login', "datetime('now')", FALSE) : $this->db->set('last_login', "NOW()", FALSE);
    ...
    */
    ...
    public function getAll($orderBy = "first_name", $orderFormat = "ASC", $start = 0, $limit = "")
    {
        ...
        $this->db->where("email != ", "admin@stkmgr.com");//added to prevent people from removing the demo admin account
    ...
    {
        $this->db->where("id != ", $_SESSION['admin_id']);
        $this->db->where("email != ", "admin@stkmgr.com");
    ...
    */
    ...
    {
        $data = ['first_name' => $first_name, 'last_name' => $last_name, 'mobile1' => $mobile1, 'mobile2' => $mobile2, 'email' => $email, 'role' => $role];
