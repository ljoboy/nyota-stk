...
function getFileError($errorCode)
{
    ...
    if ($errorCode > 0) { // if error code is greater than 0
        ...
        switch ($errorCode) {
            case 1:
                $msg = "Limite de upload_max_file dans php.ini dépassée";
                break;
            
            case 2:
                $msg = "Limite max_file_size dans html dépassée";
                break;
            
            case 3:
                $msg = "Partiellement téléchager";
                break;
            
            case 4:
                $msg = "Pas de fichier téléchargé";
                break;
            
            case 6:
                $msg = "Pas de dossier temporaire";
                break;
            
            case 7:
                $msg = "Impossible d'écrire sur le disque";
                break;
            
            case 8:
                $msg = "Téléchargement du fichier stopper ";
                break;
        }
    }
    return $msg;
