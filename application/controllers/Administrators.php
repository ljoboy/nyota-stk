...
class Administrators extends CI_Controller{
    ...
    */
    ...
    public function index(){
        ...
        $data['pageTitle'] = "Administrateurs";
    ...
    */
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('email', 'E-mail', ['trim', 'required', 'valid_email', 'is_unique[admin.email]', 'strtolower'], 
                ['required'=>"Champ obligatoire", 'is_unique'=>'Cette adresse mail existe']);
        ...
        $this->form_validation->set_rules('mobile1', 'Phone number', ['required', 'trim', 'numeric', 'max_length[15]', 'min_length[10]', 'is_unique[admin.mobile1]'],
                ['required'=>"Champ obligatoire", 'is_unique'=>"Ce numéro est déjà attaché à un administrateur"]);
        ...
        if($this->form_validation->run() !== FALSE){
            ...
            $json = $inserted ? 
                ['status'=>1, 'msg'=>"Compte admin créer avec succès"]
                : 
                ['status'=>0, 'msg'=>"Oops ! Une erreur inattendue. Veuillez contacter l'administrateur."];
        }
    ...
    */
    ...
    public function update(){
        ...
        $this->form_validation->set_rules('mobile1', 'Phone number', ['required', 'trim', 'numeric', 'max_length[15]', 
            'min_length[10]', 'callback_crosscheckMobile['. $this->input->post('adminId', TRUE).']'], ['required'=>"Champ obligatoire"]);
        ...
        if($this->form_validation->run() !== FALSE){
            ...
            $json = $updated ? 
                    ['status'=>1, 'msg'=>"Infos mise à jour avec succès"]
                    : 
                    ['status'=>0, 'msg'=>"Oops ! Erreur inattendue. Contacter l'administrateur svp !"];
        }
