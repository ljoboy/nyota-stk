...
class Administrators extends CI_Controller
{
    ...
    */
    ...
    public function add()
    {
        ...
        $this->form_validation->set_rules('mobile1', 'Phone number', ['required', 'trim', 'numeric', 'max_length[15]', 'min_length[10]', 'is_unique[admin.mobile1]'], ['required' => "Champ obligatoire", 'is_unique' => "Ce numéro est déjà attaché à un administrateur"]);
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $json = $inserted ? ['status' => 1, 'msg' => "Compte admin créer avec succès"] : ['status' => 0, 'msg' => "Oops ! Une erreur inattendue. Veuillez contacter l'administrateur."];
        } else {
