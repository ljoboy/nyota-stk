...
class Items extends CI_Controller{
    ...
    */
    ...
    public function add(){
        ...
        if($this->form_validation->run() !== FALSE){
            ...
            $insertedId ? $this->genmod->addevent("Création d'un nouveau article", $insertedId, $desc, "items", $this->session->admin_id) : "";
            
            $this->db->trans_complete();
            
            $json = $this->db->trans_status() !== FALSE ? 
                    ['status'=>1, 'msg'=>"Article ajouter avec succès"]
                    : 
    ...
    */
    ...
    public function edit(){
        ...
        $this->form_validation->set_rules('itemName', 'Nom Article', ['required', 'trim',
            'callback_crosscheckName['.$this->input->post('_iId', TRUE).']'], ['required'=>'Champ obligatoire']);
